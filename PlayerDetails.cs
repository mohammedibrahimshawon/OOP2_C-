...
namespace SoccerManagementSystem
{
    public partial class PlayerDetails : Form
    {
        ...
        private void ldbtn_Click_1(object sender, EventArgs e)
        {
              DataTable dt = DataAccess.LoadData("Server[@Name='DESKTOP-95T2N1H SQLEXPRESS']/Database[@Name='SoccerManagementSystem']/Table[@Name='Employee' and @Schema='dbo']/Data");
        ...
        private void dlbtn_Click_1(object sender, EventArgs e)
        {
            {
                if (idtxt.Text == "")
                {
