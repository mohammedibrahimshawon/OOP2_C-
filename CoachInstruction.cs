...
namespace SoccerManagementSystem
{
    public partial class CoachInstruction : Form
    {
        ...
        {
            DataTable dt = DataAccess.LoadData("Server[@Name='DESKTOP-95T2N1H SQLEXPRESS']/Database[@Name='SoccerManagementSystem']/Table[@Name='CoachInstruction' and @Schema='dbo']/Data");
